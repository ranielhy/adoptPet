...
export declare type PetCollectionOverridesProps = {
    PetCollection?: PrimitiveOverrideProps<CollectionProps>;
...
export declare type PetCollectionProps = React.PropsWithChildren<Partial<CollectionProps<any>> & {
    ...
    overrides?: PetCollectionOverridesProps | undefined | null;
}>;
